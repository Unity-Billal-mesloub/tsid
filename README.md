...
TSID is a C++ library for optimization-based inverse-dynamics control based on the rigid multi-body dynamics library [Pinocchio](https://github.com/Unity-Billal-mesloub/pinocchio).

## Documentation
* Take a look at the project [wiki](https://github.com/Unity-Billal-mesloub/tsid/wiki) for an overview of the design of the library.
...
* [eiquadprog](https://github.com/Unity-Billal-mesloub/eiquadprog)
* [example-robot-data](https://github.com/Unity-Billal-mesloub/example-robot-data) (only for running the examples)

To install eigen3 on Ubuntu you can use apt-get:
  `sudo apt-get install libeigen3-dev`

To install [pinocchio](https://github.com/Unity-Billal-mesloub/pinocchio) follow the instruction on its website.
...
To install EigenPy you can compile the source code:
    ...
    git clone https://github.com/Unity-Billal-mesloub/eigenpy
